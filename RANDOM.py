...
banner = render('{PT-7}', colors=['red', 'yellow'], align='center')
print(f'''
\033[1;37m╔════════════════════════════════════════════════════════════╗
║                                                            ║
║    \033[1;36m{banner.center(52)}\033[1;37m    ║
║                                                            ║
╠════════════════════════════════════════════════════════════╣
║               \033[1;34mDEVLOPED By ~ @PyObscura & @rvmafia              \033[1;37m║
╚════════════════════════════════════════════════════════════╝
''')


ID = input("ᴇɴᴛᴇʀ ʏᴏᴜʀ ɪᴅ :")
print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
TOKEN = input("ᴇɴᴛᴇʀ ʙᴏᴛ ᴛᴏᴋᴇɴ : ")
os.system('clear')
try:
...
{P1}[ 1 ] {F}𝐓𝐫𝐮𝐞   : [ {hits} ] 
{P1}[ 2 ] {Z}𝐅𝐚𝐥𝐬𝐞  : [ {bad_insta} ] 
{P1}[ 3 ] {J21}𝐁𝐚𝐝    : [ {bad_email} ] 
{P1}[ 4 ] {F}𝐆𝐨𝐨𝐝   : [ {good_ig} ]
{P1}[ 5 ] 𝐃𝐞𝐯 ~ @𝐏𝐲𝐨𝐛𝐬𝐜𝐮𝐫𝐚 & @𝐫𝐯𝐦𝐚𝐟𝐢𝐚
{F}___________________________________
"""
    sys.stdout.write('\r' + sysdontwrite)
    sys.stdout.flush()
